...
//			System.out.println(count);
	...
	public static void main(String[] args) {
		...
		List<Integer> result = new Find_All_Anagrams_in_a_String_438().findAnagrams("abacddba", "ab");
		...
		System.out.println(data.put(1, 1));
		System.out.println(data.put(1, 2));
		System.out.println(data.put(1, 3));
	}
